      ...
      <div class="modal-body">
          ...
          <input type="hidden" name="command" value="signIn" />
            ...
            <div class="form-group">
              <input type="text" id="signInUserEmail" class="form-control input-lg" placeholder="Email">
            </div>
            <div class="form-group">
              <input type="password" id="signInUserPwd" name="signInUserPwd" class="form-control input-lg" placeholder="Password">
            </div>
            <div class="form-group">
